...
class ExecuteCreateClinicalNoteTool implements Tool
{
    ...
    public function handle(Request $request): Stringable|string
    {
        ...
        if (! app(\Modules\AI\Classes\Services\ToolAuthorizationService::class)->userCanRun($this->user, 'execute_create_clinical_note')) {
        ...
        $noteType = NoteType::tryFrom((string) ($request['note_type'] ?? NoteType::SOAP->value)) ?? NoteType::SOAP;
